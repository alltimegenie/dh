...
console.log("heh");
{check_for_profit_percentage = setInterval(check_for_profit, 100); go_to_markets_events_id = setInterval(add_bet_finder_events, 100); check_for_autorefresh_id = setInterval(check_for_autorefresh, 100); devigging_events_id = setInterval(add_devigging_events, 100); dim_rows_id = setInterval(dim_rows, 100); delete_old_data = setInterval(delete_old_data, 30000); highlight_parlay_cell_id = setInterval(highlight_parlay_members, 100); load_league(); clear_parlay(); }